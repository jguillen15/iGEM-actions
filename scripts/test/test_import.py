...
class TestImportParts(unittest.TestCase):
    ...
    def test_import(self):
        ...
        expected = ['https://www.ncbi.nlm.nih.gov/nuccore/JWYZ01000115.1', 'http://parts.igem.org/BBa_J364007',
    ...
    def test_all_import_types(self):
        ...
        expected = ['https://www.ncbi.nlm.nih.gov/nuccore/JWYZ01000115.1',  # NCBI
